...
$kuliner = query("SELECT kuliner.id AS id_kuliner, kuliner.id_kategori, kuliner.nama AS nama_kuliner, kuliner.harga AS harga_kuliner, kategori.kategori AS kategori FROM tabel_kuliner AS kuliner INNER JOIN tabel_kategori AS kategori ON kuliner.id_kategori = kategori.id WHERE kuliner.id = $id")[0];
...
<head>
  ...
  <title>Update Kuliner - Admin Pages</title>
